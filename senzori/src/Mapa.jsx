...
import { GoogleMap, InfoWindowF, LoadScript } from "@react-google-maps/api";
    ...
    <LoadScript googleMapsApiKey={"AIzaSyDAeaWxQccUeaz-faM5JI-T-9IvIE-QL7g"}>
      <div class="main-container">
        <div className="button-container">
          <button className="btn-dodaj">Dodaj</button>
        ...
        <div className="inputs-container">
          <div className="input-container withInput">
            ...
            <button
              ...
              key={3}
              onClick={() => {
                handleButtonValues(2);
                handleButtonGet(
                  `https://localhost:7050/api/Senzor/partner/${partner}`
                );
              }}
            >
      ...
      >
        {dugmeValue &&
          svi.map((s) => (
            <>
              <GeocodeFunkcija address={s.lokacija} id={s.id} objekat={s} />
            </>
          ))}
        ...
        {buttons[0] &&
          podaci?.map((p) => (
            <>
              <GeocodeFunkcija address={p.lokacija} objekat={p} />
            </>
          ))}
